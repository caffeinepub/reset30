...
export type ChallengeId = { 'moneySaving' : null } |
  { 'mentalHealth' : null } |
  { 'fitnessReset' : null } |
  { 'glowUp' : null };
...
export interface _SERVICE {
  ...
  >,
  'getTodayCompletion' : ActorMethod<[], [bigint, Tasks]>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'markTaskComplete' : ActorMethod<[bigint, bigint], undefined>,
  'resetChallenge' : ActorMethod<[], undefined>,
  'saveCallerUserProfile' : ActorMethod<[UserProfile], undefined>,
  'startChallenge' : ActorMethod<[ChallengeId], undefined>,
}
